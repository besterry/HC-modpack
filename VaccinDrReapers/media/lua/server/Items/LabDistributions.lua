...
table.insert(ProceduralDistributions.list["ShelfGeneric"].items, 1);
table.insert(ProceduralDistributions.list["ShelfGeneric"].items, "LabBooks.BkVirologyCourses2");
table.insert(ProceduralDistributions.list["ShelfGeneric"].items, 0.5);
...
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, "LabBooks.BkLaboratoryEquipment2");
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, 2);
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, "LabBooks.BkLaboratoryEquipment3");
...
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, 3);
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, "LabBooks.BkVirologyCourses2");
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, 2);
...
table.insert(ProceduralDistributions.list["PostOfficeMagazines"].items, 1);
table.insert(ProceduralDistributions.list["PostOfficeMagazines"].items, "LabBooks.BkVirologyCourses2");
table.insert(ProceduralDistributions.list["PostOfficeMagazines"].items, 0.7);
