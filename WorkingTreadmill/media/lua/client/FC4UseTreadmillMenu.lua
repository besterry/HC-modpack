...
FC4UseTreadmillMenu.doBuildMenu = function(player, context, worldobjects)
	...
	context:addOption(getText(contextMenu),
					  worldobjects,
					  FC4UseTreadmillMenu.onUseTreadmill,
...
FC4UseTreadmillMenu.onUseTreadmill = function(worldobjects, player, machine, soundFile, soundEnd, actionType, length)
...
Events.OnPreFillWorldObjectContextMenu.Add(FC4UseTreadmillMenu.doBuildMenu);
