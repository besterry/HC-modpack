ISCarMechanicsOverlay.CarList["Base.1990traficAmbulancia"] = {imgPrefix = "1990trafic_", x=0,y=0};




ISCarMechanicsOverlay.PartList["Engine"].vehicles = ISCarMechanicsOverlay.PartList["Engine"].vehicles or {};
ISCarMechanicsOverlay.PartList["Engine"].vehicles["1990trafic_"] = {x=138,y=48,x2=237,y2=106};



ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles["1990trafic_"] = {x=81,y=201,x2=86,y2=267};

ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles["1990trafic_"] = {x=181,y=201,x2=188,y2=267};

ISCarMechanicsOverlay.PartList["DoorRearRight"].vehicles = ISCarMechanicsOverlay.PartList["DoorRearRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorRearRight"].vehicles["1990trafic_"] = {x=185,y=273,x2=197,y2=329};
...
ISCarMechanicsOverlay.PartList["WindshieldRear"].vehicles["1990trafic_"] = {x=95,y=447,x2=172,y2=454};

ISCarMechanicsOverlay.PartList["Windshield"].vehicles = ISCarMechanicsOverlay.PartList["Windshield"].vehicles or {};
ISCarMechanicsOverlay.PartList["Windshield"].vehicles["1990trafic_"] = {x=86,y=174,x2=181,y2=222};




ISCarMechanicsOverlay.PartList["TruckBed"].vehicles = ISCarMechanicsOverlay.PartList["TruckBed"].vehicles or {};
ISCarMechanicsOverlay.PartList["TruckBed"].vehicles["1990trafic_"] = {x=90,y=444,x2=177,y2=462};
