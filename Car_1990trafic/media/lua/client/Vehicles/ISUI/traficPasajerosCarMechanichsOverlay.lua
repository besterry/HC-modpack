ISCarMechanicsOverlay.CarList["Base.1990traficPasajeros"] = {imgPrefix = "1990traficpasajeros_", x=0,y=0};




ISCarMechanicsOverlay.PartList["Engine"].vehicles = ISCarMechanicsOverlay.PartList["Engine"].vehicles or {};
ISCarMechanicsOverlay.PartList["Engine"].vehicles["1990traficpasajeros_"] = {x=138,y=48,x2=237,y2=106};



ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles["1990traficpasajeros_"] = {x=81,y=201,x2=86,y2=267};

ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles["1990traficpasajeros_"] = {x=181,y=201,x2=188,y2=267};

ISCarMechanicsOverlay.PartList["DoorRearRight"].vehicles = ISCarMechanicsOverlay.PartList["DoorRearRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorRearRight"].vehicles["1990traficpasajeros_"] = {x=185,y=273,x2=197,y2=329};
...
ISCarMechanicsOverlay.PartList["EngineDoor"].vehicles["1990traficpasajeros_"] = {x=77,y=151,x2=190,y2=166};

ISCarMechanicsOverlay.PartList["TireFrontLeft"].vehicles = ISCarMechanicsOverlay.PartList["TireFrontLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["TireFrontLeft"].vehicles["1990traficpasajeros_"] = {x=64,y=171,x2=70,y2=236};

ISCarMechanicsOverlay.PartList["TireFrontRight"].vehicles = ISCarMechanicsOverlay.PartList["TireFrontRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["TireFrontRight"].vehicles["1990traficpasajeros_"] = {x=197,y=171,x2=202,y2=236};

ISCarMechanicsOverlay.PartList["TireRearLeft"].vehicles = ISCarMechanicsOverlay.PartList["TireRearLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["TireRearLeft"].vehicles["1990traficpasajeros_"] = {x=64,y=358,x2=69,y2=423};

ISCarMechanicsOverlay.PartList["TireRearRight"].vehicles = ISCarMechanicsOverlay.PartList["TireRearRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["TireRearRight"].vehicles["1990traficpasajeros_"] = {x=197,y=358,x2=203,y2=423};




ISCarMechanicsOverlay.PartList["WindowFrontLeft"].vehicles = ISCarMechanicsOverlay.PartList["WindowFrontLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["WindowFrontLeft"].vehicles["1990traficpasajeros_"] = {x=70,y=187,x2=79,y2=255};

ISCarMechanicsOverlay.PartList["WindowFrontRight"].vehicles = ISCarMechanicsOverlay.PartList["WindowFrontRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["WindowFrontRight"].vehicles["1990traficpasajeros_"] = {x=188,y=187,x2=197,y2=255};



ISCarMechanicsOverlay.PartList["WindowRearLeft"].vehicles = ISCarMechanicsOverlay.PartList["WindowRearLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["WindowRearLeft"].vehicles["1990traficpasajeros_"] = {x=74,y=335,x2=80,y2=408};

ISCarMechanicsOverlay.PartList["WindowRearRight"].vehicles = ISCarMechanicsOverlay.PartList["WindowRearRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["WindowRearRight"].vehicles["1990traficpasajeros_"] = {x=188,y=335,x2=193,y2=408};
...
ISCarMechanicsOverlay.PartList["WindshieldRear"].vehicles["1990traficpasajeros_"] = {x=95,y=447,x2=172,y2=454};

ISCarMechanicsOverlay.PartList["Windshield"].vehicles = ISCarMechanicsOverlay.PartList["Windshield"].vehicles or {};
ISCarMechanicsOverlay.PartList["Windshield"].vehicles["1990traficpasajeros_"] = {x=86,y=174,x2=181,y2=222};




ISCarMechanicsOverlay.PartList["TruckBed"].vehicles = ISCarMechanicsOverlay.PartList["TruckBed"].vehicles or {};
ISCarMechanicsOverlay.PartList["TruckBed"].vehicles["1990traficpasajeros_"] = {x=90,y=444,x2=177,y2=462};
