...
function recipe_hcspindle6(items, result, player)
	HCAddManySameItem("Hydrocraft.HCSpindle", 5, player);
end
...
function recipe_hcDismEguitar(items, result, player)
	HCAddManySameItem("Hydrocraft.HCSwitch", 0, player);
	HCAddManySameItem("Hydrocraft.HCColoredwire", 1, player);
	HCAddManySameItem("Base.ElectronicsScrap", 1, player);
end
...
function recipe_hcdismantlewagon(items, result, player)
	HCAddManySameItem("Base.MetalBar", 5, player);
	HCAddManySameItem("Hydrocraft.HCMetalwheel", 0, player);
	HCAddManySameItem("Hydrocraft.HCRubberscrap", 1, player);
	HCAddManySameItem("Hydrocraft.HCSteelsheet", 2, player);
end
...
function recipe_hcdismantForklift(items, result, player)
	HCAddManySameItem("Base.MetalBar", 9, player);
	HCAddManySameItem("Hydrocraft.HCMetalwheel", 3, player);
	HCAddManySameItem("Hydrocraft.HCRubberscrap", 8, player);
	HCAddManySameItem("Hydrocraft.HCSteelsheet", 4, player);
	HCAddManySameItem("Hydrocraft.ElectronicsScrap", 17, player);
	HCAddManySameItem("EngineParts", 8, player);
end
...
function HCRandomGiftGet(items, result, player)
	giftSet = { "Hydrocraft.HCBookanarchist", "Hydrocraft.HCBinoculars", "Hydrocraft.HCCamera", "Hydrocraft.HCCalculator",
		"Hydrocraft.HCLaserpointer", "Base.Spiffo", "Hydrocraft.HCToyrobot", "Hydrocraft.HCToydrawing",
		"Hydrocraft.HCDVDPlayer", "Base.Book", "Base.WhiskeyFull", "Base.Wine", "Base.Wine2", "Base.FishingRod",
		"Base.Headphones", "Base.Radio", "Base.DigitalWatch", "Hydrocraft.HCFlashlightoff", "Hydrocraft.HCBookbedtime",
		"Hydrocraft.HCBookfairytale", "Hydrocraft.HCDogwhistle" };
...
function getGoat(items, result, player)
	if (player:isOutside() == false) then
		player:Say(getText('ContextMenu_cannotfindanythingindoors'));
