...
MSTBaseGameCharacterDetails.DoTraits = function()
	...
	-- Mixed traits	
	local marathonrunner = TraitFactory.addTrait("MarathonRunner", getText("UI_trait_marathonrunner"), 5, getText("UI_trait_marathonrunnerdesc"), false);
	...
	local mushroomer = TraitFactory.addTrait("Mushroomer", getText("UI_trait_mushroomer"), 4, getText("UI_trait_mushroomerdesc"), false);
    ...
    local swordsman = TraitFactory.addTrait("Swordsman", getText("UI_trait_swordsman"), 5, getText("UI_trait_swordsmandesc"), false);
	...
	local sharpshooter = TraitFactory.addTrait("Sharpshooter", getText("UI_trait_sharpshooter"), 6, getText("UI_trait_sharpshooterdesc"), false);
    ...
    local weathersensitive = TraitFactory.addTrait("WeatherSensitive", getText("UI_trait_weathersensitive"), -3, getText("UI_trait_weathersensitivedesc"), false, true);
...
MSTBaseGameCharacterDetails.DoNewCharacterInitializations = function(playernum, character)
...
MSTBaseGameCharacterDetails.DoExistingCharacterInitializations = function(player)
...
Events.OnGameBoot.Add(MSTBaseGameCharacterDetails.DoTraits);
Events.OnCreatePlayer.Add(MSTBaseGameCharacterDetails.DoNewCharacterInitializations);
