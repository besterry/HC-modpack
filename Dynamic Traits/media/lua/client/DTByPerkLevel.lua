...
function traitsGainsByLevel(player, perk, perkLevel)
    ...
    if perk == Perks.Sneak then
        ...
        if perkLevel >= 5 and player:getPerkLevel(Perks.Aiming) >= 5 and player:getPerkLevel(Perks.Trapping) >= 5 and player:getPerkLevel(Perks.SmallBlade) >= 5 and not player:HasTrait("Hunter") then
    ...
    if perk == Perks.Aiming then
        ...
        if perkLevel >= 5 and player:getPerkLevel(Perks.Trapping) >= 5 and player:getPerkLevel(Perks.Sneak) >= 5 and player:getPerkLevel(Perks.SmallBlade) >= 5 and not player:HasTrait("Hunter") then
            player:getTraits():add("Hunter");
            applyXPBoost(player, Perks.Sneak, 1);
            applyXPBoost(player, Perks.Aiming, 1);
            applyXPBoost(player, Perks.Trapping, 1);
    ...
    if perk == Perks.SmallBlade then
        ...
        if perkLevel >= 5 and player:getPerkLevel(Perks.Aiming) >= 5 and player:getPerkLevel(Perks.Trapping) >= 5 and player:getPerkLevel(Perks.Sneak) >= 5 and not player:HasTrait("Hunter") then
            player:getTraits():add("Hunter");
            applyXPBoost(player, Perks.Sneak, 1);
            applyXPBoost(player, Perks.Aiming, 1);
            applyXPBoost(player, Perks.Trapping, 1);
    ...
    if perk == Perks.Doctor then
        -- Gain trait "FirstAid" when reaching First Aid Lv5.
        if perkLevel >= 5 and not player:HasTrait("FirstAid") then
    ...
    if perk == Perks.Tailoring then
        ...
        if perkLevel >= 7 and not player:HasTrait("Tailor") then
    ...
    if perk == Perks.Fishing then
        ...
        if perkLevel >= 6 and not player:HasTrait("Fishing") then
    ...
    if perk == Perks.Trapping then
        ...
        if perkLevel >= 5 and player:getPerkLevel(Perks.Aiming) >= 5 and player:getPerkLevel(Perks.Sneak) >= 5 and player:getPerkLevel(Perks.SmallBlade) >= 5 and not player:HasTrait("Hunter") then
            player:getTraits():add("Hunter");
            applyXPBoost(player, Perks.Sneak, 1);
            applyXPBoost(player, Perks.Aiming, 1);
            applyXPBoost(player, Perks.Trapping, 1);
