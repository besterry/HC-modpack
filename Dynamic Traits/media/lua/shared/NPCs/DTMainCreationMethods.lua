...
DTBaseGameCharacterDetails.DoTraits = function()
    ...
    if MSTBaseGameCharacterDetails then
        print("DT Logger: MoreSimpleTraits detected, running DoTrait function");
        MSTBaseGameCharacterDetails.DoTraits();
    end ]]
...
DTBaseGameCharacterDetails.DoNewCharacterInitializations = function(playernum, character)
    ...
    -- INITIALIZATION FOR PILLS OVERDOSE 
    if player:getModData().DTPillsOverdose == nil then
...
DTBaseGameCharacterDetails.DoExistingCharacterInitializations = function(player)
    ...
    if (player:getModData().DTKillsPath == nil or player:getModData().DTKillscheck2 == nil or
        ...
        player:getModData().DTthresholdToObtainAlcoholic == nil or player:getModData().DTthresholdToObtainLoseAnorexy ==
        nil or player:getModData().DTObtainLoseActiveSedentary == nil or player:getModData().DTKeenHardOfHearing == nil or
        player:getModData().DTSlowFastLearner == nil or player:getModData().DTgenerateAColdChance == nil
        or player:getModData().DTisNervousWreck == nil or player:getModData().DTisMelancholic == nil
        or player:getModData().DTPillsBeta == nil or player:getModData().DTPillsAntiDep == nil
        or player:getModData().DTPillsOverdose == nil) then
