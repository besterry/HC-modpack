ISCarMechanicsOverlay.CarList["Base.1979rastrojeroChata"] = {imgPrefix = "1979rastrojero_", x=0,y=0};

ISCarMechanicsOverlay.PartList["Engine"].vehicles = ISCarMechanicsOverlay.PartList["Engine"].vehicles or {};
ISCarMechanicsOverlay.PartList["Engine"].vehicles["1979rastrojero_"] = {x=138,y=48,x2=237,y2=106};



ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles["1979rastrojero_"] = {x=71,y=236,x2=80,y2=300};

ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles["1979rastrojero_"] = {x=186,y=236,x2=196,y2=300};
...
ISCarMechanicsOverlay.PartList["WindshieldRear"].vehicles["1979rastrojero_"] = {x=95,y=292,x2=171,y2=300};

ISCarMechanicsOverlay.PartList["Windshield"].vehicles = ISCarMechanicsOverlay.PartList["Windshield"].vehicles or {};
ISCarMechanicsOverlay.PartList["Windshield"].vehicles["1979rastrojero_"] = {x=95,y=230,x2=171,y2=247};




ISCarMechanicsOverlay.PartList["TruckBed"].vehicles = ISCarMechanicsOverlay.PartList["TruckBed"].vehicles or {};
ISCarMechanicsOverlay.PartList["TruckBed"].vehicles["1979rastrojero_"] = {x=83,y=433,x2=184,y2=440};
