...
function M151A2.extractCond(player)
	local vehicle = player:getVehicle()
	if (vehicle and string.find( vehicle:getScriptName(), "74amgeneralM151A2" )) then
...
function M151A2.activeArmor(player)
    local vehicle = player:getVehicle()
    	if (vehicle and string.find( vehicle:getScriptName(), "74amgeneralM151A2" )) then
		...
		--
			...
			local protection = vehicle:getPartById("M151A2WindshieldArmor")
		...
		local protection = vehicle:getPartById("DoorFrontLeft")
		...
		local protection = vehicle:getPartById("DoorFrontRight")
			...
			local protection = vehicle:getPartById("M151A2Bumper")
...
Events.OnEnterVehicle.Add(M151A2.extractCond);
Events.OnPlayerUpdate.Add(M151A2.activeArmor);