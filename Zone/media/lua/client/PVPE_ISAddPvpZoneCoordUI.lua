...
PVPE_ISAddNonPvpZoneCoordUI = ISPanel:derive("PVPE_ISAddNonPvpZoneCoordUI");

local FONT_HGT_SMALL = getTextManager():getFontHeight(UIFont.Small)
local FONT_HGT_MEDIUM = getTextManager():getFontHeight(UIFont.Medium)

function PVPE_ISAddNonPvpZoneCoordUI:initialise()
    ...
    self.cancel = ISButton:new(self:getWidth() - btnWid - 10, self:getHeight() - padBottom - btnHgt, btnWid, btnHgt, getText("UI_Cancel"), self, PVPE_ISAddNonPvpZoneCoordUI.onClick);
    ...
    self.ok = ISButton:new(10, self:getHeight() - padBottom - btnHgt, btnWid, btnHgt, getText("IGUI_PvpZone_AddZone"), self, PVPE_ISAddNonPvpZoneCoordUI.onClick);
    self.ok.internal = "OK";
...
function PVPE_ISAddNonPvpZoneCoordUI:prerender()
    local z = 20;
...
function PVPE_ISAddNonPvpZoneCoordUI:updateButtons()
    self.ok.enable = 
...
function PVPE_ISAddNonPvpZoneCoordUI:onClick(button)
...
--Создание окна
function PVPE_ISAddNonPvpZoneCoordUI:new(x, y, width, height, player)
    local o = {}
    ...
    PVPE_ISAddNonPvpZoneCoordUI.instance = o;
