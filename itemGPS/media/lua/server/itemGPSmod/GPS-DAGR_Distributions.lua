...
--	table.insert(SuburbsDistributions["all"]["Outfit_Tourist"].items, "Base.GPS_DAGR");--
...
--	table.insert(SuburbsDistributions["all"]["Outfit_Camper"].items, "Base.GPS_DAGR");--
--	table.insert(SuburbsDistributions["all"]["Outfit_Camper"].items, 0.25*Multiplier);
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Survivalist"].items, "Base.GPS_DAGR");--
	table.insert(SuburbsDistributions["all"]["Outfit_Survivalist"].items, 0.1*Multiplier);
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Survivalist02"].items, "Base.GPS_DAGR");--
	table.insert(SuburbsDistributions["all"]["Outfit_Survivalist02"].items, 0.1*Multiplier);
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Survivalist03"].items, "Base.GPS_DAGR");--
	table.insert(SuburbsDistributions["all"]["Outfit_Survivalist03"].items, 0.1*Multiplier);
...
--	table.insert(SuburbsDistributions["all"]["Outfit_AmbulanceDriver"].items, "Base.GPS_DAGR");--
...
--	table.insert(SuburbsDistributions["all"]["Outfit_FiremanFullSuit"].items, "Base.GPS_DAGR");--
...
--	table.insert(SuburbsDistributions["all"]["Outfit_Police"].items, "Base.GPS_DAGR");--
...
--	table.insert(SuburbsDistributions["all"]["Outfit_PoliceState"].items, "Base.GPS_DAGR");--
...
--	table.insert(SuburbsDistributions["all"]["Outfit_PrivateMilitia"].items, "Base.GPS_DAGR");--
...
------------------------------------------------
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Ranger"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Hunter"].items, "Base.GPS_DAGR");--
...
----------------------------------------------
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Ghillie"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["all"]["Outfit_ArmyCamoGreen"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["all"]["Outfit_ArmyCamoDesert"].items, "Base.GPS_DAGR");--
...
----------------------------------------------------------------------------------------------------------------
	...
	table.insert(SuburbsDistributions["Bag_WeaponBag"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["Bag_SurvivorBag"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["SurvivorCache1"]["SurvivorCrate"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["SurvivorCache2"]["SurvivorCrate"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["Bag_ALICEpack"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["Bag_ALICEpack_Army"].items, "Base.GPS_DAGR");--
	...
	table.insert(SuburbsDistributions["Bag_Military"].items, "Base.GPS_DAGR");--
...
--	table.insert(ProceduralDistributions.list["CrateRandomJunk"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["CrateRandomJunk"].items, 0.01*Multiplier);
--
--
----------------------------------------------------------
--
--	table.insert(ProceduralDistributions.list["ControlRoomCounter"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["ControlRoomCounter"].items, 0.8*Multiplier);
--
--	table.insert(ProceduralDistributions.list["JanitorMisc"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["JanitorMisc"].items, 0.5*Multiplier);
--
--	table.insert(ProceduralDistributions.list["CrateElectronics"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["CrateElectronics"].items, 0.1*Multiplier);
--
--	table.insert(ProceduralDistributions.list["ElectronicStoreMisc"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["ElectronicStoreMisc"].items, 0.8*Multiplier);
--
--	table.insert(ProceduralDistributions.list["StoreShelfElectronics"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["StoreShelfElectronics"].items, 0.8*Multiplier);
--
--	table.insert(ProceduralDistributions.list["GigamartHouseElectronics"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["GigamartHouseElectronics"].items, 0.8*Multiplier);
--
--	table.insert(ProceduralDistributions.list["CampingLockers"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["CampingLockers"].items, 0.05*Multiplier);
--
--
----------------------------------------------------------
--
--	table.insert(ProceduralDistributions.list["CampingStoreGear"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["CampingStoreGear"].items, 0.05*Multiplier);
--
--	--table.insert(ProceduralDistributions.list["ElectronicStoreHAMRadio"].items, "Base.GPS_DAGR");--
--	--table.insert(ProceduralDistributions.list["ElectronicStoreHAMRadio"].items, 3.6*Multiplier);
--
--	table.insert(ProceduralDistributions.list["GunStoreCounter"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["GunStoreCounter"].items, 0.3*Multiplier);
--
--	table.insert(ProceduralDistributions.list["GunStoreDisplayCase"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["GunStoreDisplayCase"].items, 0.3*Multiplier);
--
--	table.insert(ProceduralDistributions.list["GunStoreShelf"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["GunStoreShelf"].items, 0.3*Multiplier);

	--table.insert(ProceduralDistributions.list["FirearmWeapons"].items, "Base.GPS_DAGR");--
...
--	table.insert(ProceduralDistributions.list["FireDeptLockers"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["FireDeptLockers"].items, 0.2*Multiplier);
--
--	table.insert(ProceduralDistributions.list["FireStorageOutfit"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["FireStorageOutfit"].items, 0.2*Multiplier);

    --table.insert(ProceduralDistributions.list["PoliceStorageGuns"].items, "Base.GPS_DAGR");--
	--table.insert(ProceduralDistributions.list["PoliceStorageGuns"].items, 1.35*Multiplier);

	--table.insert(ProceduralDistributions.list["PoliceStorageAmmunition"].items, "Base.GPS_DAGR");--
	--table.insert(ProceduralDistributions.list["PoliceStorageAmmunition"].items, 1.35*Multiplier);
	
--	table.insert(ProceduralDistributions.list["PoliceDesk"].items, "Base.GPS_DAGR");--
--	table.insert(ProceduralDistributions.list["PoliceDesk"].items, 0.2*Multiplier);

	table.insert(ProceduralDistributions.list["PoliceLockers"].items, "Base.GPS_DAGR");--
	table.insert(ProceduralDistributions.list["PoliceLockers"].items, 0.3*Multiplier);

	table.insert(ProceduralDistributions.list["PoliceStorageOutfit"].items, "Base.GPS_DAGR");--
	table.insert(ProceduralDistributions.list["PoliceStorageOutfit"].items, 0.3*Multiplier);


-----------------------------------------------------------
	table.insert(ProceduralDistributions.list["LockerArmyBedroom"].items, "Base.GPS_DAGR");--
	table.insert(ProceduralDistributions.list["LockerArmyBedroom"].items, 0.2*Multiplier);	

	table.insert(ProceduralDistributions.list["ArmyHangarOutfit"].items, "Base.GPS_DAGR");--
	table.insert(ProceduralDistributions.list["ArmyHangarOutfit"].items, 0.8*Multiplier);

	--table.insert(ProceduralDistributions.list["ArmyStorageGuns"].items, "Base.GPS_DAGR");--
	--table.insert(ProceduralDistributions.list["ArmyStorageGuns"].items, 0.5*Multiplier);

	table.insert(ProceduralDistributions.list["ArmySurplusMisc"].items, "Base.GPS_DAGR");--
	table.insert(ProceduralDistributions.list["ArmySurplusMisc"].items, 0.2*Multiplier);

	table.insert(ProceduralDistributions.list["ArmyStorageElectronics"].items, "Base.GPS_DAGR");--
...
--	table.insert(VehicleDistributions["GloveBox"].junk.items, "Base.GPS_DAGR");--
...
----------------------------------------------		
	...
	table.insert(VehicleDistributions["SurvivalistTruckBed"].junk.items, "Base.GPS_DAGR");--
...
--	table.insert(VehicleDistributions["FireGloveBox"].junk.items, "Base.GPS_DAGR");--
...
--	table.insert(VehicleDistributions["TaxiGloveBox"].junk.items, "Base.GPS_DAGR");--
...
--	table.insert(VehicleDistributions["PostalGloveBox"].junk.items, "Base.GPS_DAGR");--
...
--	table.insert(VehicleDistributions["AmbulanceGloveBox"].junk.items, "Base.GPS_DAGR");--
...
----------------------------------------------
	...
	table.insert(VehicleDistributions["PoliceTruckBed"].junk.items, "Base.GPS_DAGR");--
...
--	table.insert(VehicleDistributions["PoliceGloveBox"].junk.items, "Base.GPS_DAGR");--
...
----------------------------------------------
	...
	table.insert(VehicleDistributions["RangerTruckBed"].junk.items, "Base.GPS_DAGR");--
	...
	table.insert(VehicleDistributions["RangerGloveBox"].junk.items, "Base.GPS_DAGR");--
	...
	table.insert(VehicleDistributions["HunterTruckBed"].junk.items, "Base.GPS_DAGR");--
	...
	table.insert(VehicleDistributions["HunterGloveBox"].junk.items, "Base.GPS_DAGR");--
