...
function ISVehicleACUI:addKnobValues()
	...
	self.tempKnob:addValue(15, 8);
	self.tempKnob:addValue(30, 25);
	self.tempKnob:addValue(45, 45);
	self.tempKnob:addValue(60, 60);
	self.tempKnob:addValue(75, 75);
	self.tempKnob:addValue(90, 90);
	self.tempKnob:addValue(270, -90);
	self.tempKnob:addValue(285, -75);
	self.tempKnob:addValue(300, -65);
	self.tempKnob:addValue(315, -45);
	self.tempKnob:addValue(330, -20);
end
