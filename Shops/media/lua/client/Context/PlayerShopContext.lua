...
function PlayerShop.addPlayerShop(worldobjects, playerNum,sprites)
	...
	--Координаты границ торговой зоны
	local x1 = 8300 / 100   	--X минимальное
	local x2 = 9000 / 100 		--X макс
	local y1 = 6800 / 100 		--Y мин
	local y2 = 7200 / 100 		--Y макс
	if checkShopZones(x,y,x1,x2,y1,y2) then 
		local player = getSpecificPlayer(playerNum)
