ISCarMechanicsOverlay.CarList["Base.1988fuegoTuning"] = {imgPrefix = "1988fuego_", x=0,y=0};

ISCarMechanicsOverlay.PartList["Engine"].vehicles = ISCarMechanicsOverlay.PartList["Engine"].vehicles or {};
ISCarMechanicsOverlay.PartList["Engine"].vehicles["1988fuego_"] = {x=138,y=48,x2=237,y2=106};



ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles["1988fuego_"] = {x=77,y=255,x2=86,y2=322};

ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles["1988fuego_"] = {x=186,y=255,x2=194,y2=322};
