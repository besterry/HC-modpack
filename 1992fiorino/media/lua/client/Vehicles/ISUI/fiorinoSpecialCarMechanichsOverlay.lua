ISCarMechanicsOverlay.CarList["Base.1992fiorinoSpecial"] = {imgPrefix = "1992fiorino_", x=0,y=0};

ISCarMechanicsOverlay.PartList["Engine"].vehicles = ISCarMechanicsOverlay.PartList["Engine"].vehicles or {};
ISCarMechanicsOverlay.PartList["Engine"].vehicles["1992fiorino_"] = {x=138,y=48,x2=237,y2=106};



ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontLeft"].vehicles["1992fiorino_"] = {x=78,y=237,x2=85,y2=318};

ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles = ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["DoorFrontRight"].vehicles["1992fiorino_"] = {x=184,y=241,x2=190,y2=318};
...
ISCarMechanicsOverlay.PartList["WindshieldRear"].vehicles["1992fiorino_"] = {x=95,y=378,x2=173,y2=411};

ISCarMechanicsOverlay.PartList["Windshield"].vehicles = ISCarMechanicsOverlay.PartList["Windshield"].vehicles or {};
ISCarMechanicsOverlay.PartList["Windshield"].vehicles["1992fiorino_"] = {x=90,y=240,x2=179,y2=269};




ISCarMechanicsOverlay.PartList["TruckBed"].vehicles = ISCarMechanicsOverlay.PartList["TruckBed"].vehicles or {};
ISCarMechanicsOverlay.PartList["TruckBed"].vehicles["1992fiorino_"] = {x=89,y=375,x2=179,y2=428};
