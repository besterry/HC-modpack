...
function hcmetalsearch(items, result, player)
    ...
    nice = {'Base.UnusableMetal','Base.ScrapMetal','Hydrocraft.HCBatterymedium','Hydrocraft.HCManometer','Hydrocraft.HCMagnetite','Hydrocraft.HCValve','Hydrocraft.HCShears','Base.EngineParts','Hydrocraft.HCMagnetite','Hydrocraft.HCChain'}
    jackpot = {'Hydrocraft.HCSpearsteel','Hydrocraft.HCDogwhistle','Hydrocraft.HCSkullsplitter','Base.Katana','Base.BarBell','Base.BlowTorch','Base.PickAxe','Hydrocraft.HCIroningot'}
