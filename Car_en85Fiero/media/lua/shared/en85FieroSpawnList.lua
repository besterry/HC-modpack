...
VehicleZoneDistribution.parkingstall.vehicles["Base.en85Fiero"] = {index = -1, spawnChance = 2};

-- Trailer Parks, have a chance to spawn burnt cars, some on top of each others, it's like a pile of junk cars
VehicleZoneDistribution.trailerpark.vehicles["Base.en85Fiero"] = {index = -1, spawnChance = 3};

-- bad vehicles, moslty used in poor area, sometimes around pub etc.
VehicleZoneDistribution.bad.vehicles["Base.en85Fiero"] = {index = -1, spawnChance = 3};

-- medium vehicles, used in some of the good looking area, or in suburbs
VehicleZoneDistribution.medium.vehicles["Base.en85Fiero"] = {index = -1, spawnChance = 1};

-- junkyard, spawn damaged & burnt vehicles, less chance of finding keys but more cars.
-- also used for the random car crash.
VehicleZoneDistribution.junkyard.vehicles["Base.en85Fiero"] = {index = -1, spawnChance = 3};
